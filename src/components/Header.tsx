      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-10 py-3 sm:py-4 lg:py-3 flex justify-between items-center">
        <Link href="/" className="flex items-center">
          <div className="flex flex-col leading-tight">
            <span className="text-lg sm:text-xl lg:text-2xl font-bold" style={{ color: '#1a365d', fontFamily: 'Plus Jakarta Sans' }}>
              Enabled Talent
            </span>
        ...
        <div className="hidden md:flex items-center gap-3">
          <Link href="https://app.enabledtalent.com/candidate-login/" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-blue-600 text-sm font-medium">
            Login
          </Link>
          <a href="https://app.enabledtalent.com/candidate-signup/" target="_blank" rel="noopener noreferrer" className="text-white px-4 py-2 rounded-lg text-sm font-medium hover:opacity-90 transition-opacity inline-block" style={{ backgroundColor: '#1a365d' }}>
            Sign up
          </a>
        </div>
        ...
        <div className="lg:hidden bg-white border-t border-gray-200">
          <div className="px-4 py-4 space-y-4">
            ...
            <div className="flex flex-col gap-3 pt-4 border-t border-gray-200">
              ...
              <a href="https://app.enabledtalent.com/candidate-signup/" target="_blank" rel="noopener noreferrer" className="text-white px-4 py-2 rounded-lg text-sm font-medium w-full hover:opacity-90 transition-opacity inline-block text-center" style={{ backgroundColor: '#1a365d' }}>
                Sign up
              </a>
            </div>
          </div>
